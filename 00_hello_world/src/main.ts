if (typeof fin !== 'undefined') {
    console.log('Hello openfin');
    document.getElementById('app').innerHTML = 'Hello Openfin';
} else {
...
// fetch(document.location.href + 'readme.md').then(async (res) => {
//     const readmeDiv = document.getElementById('readme');
//     readmeDiv.innerHTML = markdownToHTML(await res.text());
// });